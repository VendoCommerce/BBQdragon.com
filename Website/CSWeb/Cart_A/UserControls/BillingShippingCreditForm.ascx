...
<asp:UpdatePanel ID="upBillingForm" runat="server">
    <ContentTemplate>    
     ...
     <asp:CheckBox ID="cbShippingSame" runat="server" CssClass="checkbox-right" OnCheckedChanged="cbShippingSame_CheckedChanged" AutoPostBack="true" Checked="true" />
            </div>
            ...
            <div class="form_line clearfix">
                <label class="label-3">
                    Card Verification* <a class="cvv" href="/content/images/cvv.png">(What is this?)</a>
                </label>
                <div class="error-2">
