<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactUs_PlaceHolder.ascx.cs" Inherits="CSWeb.Mobile.UserControls.ContactUs_PlaceHolder" %>
  ...
  <tr>
    <td colspan="2" align="left"><asp:ImageButton ID="ImageButtonSubmit" src="/Content/images/submit_btn.jpg"
