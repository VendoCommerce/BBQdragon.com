...
{
    public partial class ShoppingCartControl2 : System.Web.UI.UserControl
    {
        ...
        public void BindControls()
        {
            if (CartContext.CartInfo.CartItems.Count > 0)
            {
                ...
                lblShipping.Text = String.Format("${0:0.00}", CartContext.CartInfo.ShippingCost + CartContext.CartInfo.AdditionalShippingCharge);
                ...
                if (CartContext.CartInfo.ShippingChargeKey != null)
                {
                    //holderRushShippingTotal.Visible = false;
                        //chkIncludeRushShipping.Checked = (CartContext.CartInfo.ShippingChargeKey.ToLower().Equals("alacartskurushshipping"));
                }
        ...
        //{
        //    if (chkIncludeRushShipping.Checked)
        //    {
        ...
        //            if (s.ContainsAttribute("RushShippingChargeKey"))
        //            {
        //                CartContext.CartInfo.ShippingChargeKey = s.GetAttributeValue<string>("RushShippingChargeKey", null);
        //            }
        ...
        //            if (s.ContainsAttribute("ShippingChargeKey"))
        //            {
        //                CartContext.CartInfo.ShippingChargeKey = s.GetAttributeValue<string>("ShippingChargeKey", null);
        //            }
